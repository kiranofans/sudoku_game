            ...
            <div className="space-x-4 flex flex-row relative justify-center items-center">
                ...
                <svg onClick={() => openShare(shareLinks.linkedin(showShareText, url))}
                    ...
                    <g clip-path="url(#clip0_1479_10122)">
                        ...
                        <path d="M7.56828 17.5122H14.0766V38.453H7.56828V17.5122ZM10.8242 7.09033C11.5707 7.09033 12.3004 7.31173 12.921 7.72652C13.5416 8.14131 14.0253 8.73085 14.3108 9.42057C14.5963 10.1103 14.6708 10.8692 14.5249 11.6013C14.379 12.3333 14.0193 13.0057 13.4912 13.5333C12.9631 14.0608 12.2904 14.4199 11.5582 14.5651C10.826 14.7103 10.0671 14.6351 9.3777 14.3489C8.68825 14.0628 8.09917 13.5786 7.68497 12.9576C7.27078 12.3366 7.05007 11.6066 7.05078 10.8602C7.05174 9.86002 7.44971 8.90116 8.15727 8.19428C8.86482 7.4874 9.82406 7.09033 10.8242 7.09033ZM18.1591 17.5122H24.3978V20.3872H24.4841C25.3538 18.7413 27.4741 17.0055 30.6402 17.0055C37.2311 16.9911 38.453 21.3288 38.453 26.953V38.453H31.9447V28.2647C31.9447 25.8389 31.9016 22.716 28.563 22.716C25.2244 22.716 24.6566 25.361 24.6566 28.1066V38.453H18.1591V17.5122Z" fill="white" />
                    </g>
                    <defs>
