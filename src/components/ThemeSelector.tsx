...
const ThemeSelector: React.FC = () => {
    ...
    return (
                    ...
                    >
                        {resolvedTheme === 'dark' ? (
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                                ...
                                <title className='sr-only' id='svg-title'>Theme icon button (white for dark theme)</title>
                                <desc id='svg-description'>Dark mode icon button for changing theme</desc>
                            ...
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                                className="theme-icon-img" aria-labelledby='svg-title svg-description'>
                                <title className='sr-only' id='svg-title'>Theme icon button (black for light theme)</title>
                                <desc id='svg-description'>Light mode icon button for changing theme</desc>
                                <g>
        ...
        >
            <button className={`theme-menu-item ${theme === 'light' ? 'active' : ''}`} onClick={() => setTheme('light')}>Light</button>
            <button className={`theme-menu-item ${theme === 'dark' ? 'active' : ''}`} onClick={() => setTheme('dark')}>Dark</button>
            <button className={`theme-menu-item ${theme === 'system' ? 'active' : ''}`} onClick={() => setTheme('system')}>System</button>
        </Dropdown>
    );
};
